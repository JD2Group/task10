...
public abstract class MockConstants {
    ...
    public static final String GET_COURSES_BY_STUDENT_QUERY = "select * from courses where id IN (SELECT course_id from students_courses where student_id = ?1)";
    public static final String GET_COURSES_WITHOUT_CURRENT_STUDENT_QUERY = "select * from courses where id NOT IN (SELECT course_id from students_courses where student_id = ?1)";
    ...
    public static final String GET_TASK_BY_COURSE_QUERY = "select * from tasks where course_id = ?1";
    public static final String GET_SOLUTIONS_QUERY = "select * from solutions where readyForReview = 0";
}
